 ...
 * @param[in] ppc_output_data Pointer to the buffer that will hold the decompressed output data
 ...
 */
static s32 s32_rle_decompress(const char *pc_input_data, const u64 u64_input_data_size, char **ppc_output_data, u64 *pu64_output_data_size)
{
    ...
    else
    {
        ...
        for (u64 i = 0; i < u64_input_data_size; i++)
        {
            ...
            (*ppc_output_data)[u64_write_idx++] = non_digit_char;
